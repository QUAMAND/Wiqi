...
[[:paper: 02-1 함수란?](/Wiqi/doc/1/02/1)] 페이지에서 만들었던 함수처럼, `predicate` 폴더를 만듭니다.

   <video width="640" height="360" controls>
      <source src="public/vid/03-1/predicate_folder.mp4" type="video/mp4">
   </video>
...
`Root` 밑에 있는 `Condition` 목록을 클릭해 사용 가능한 조건을 확인할 수 있습니다.
   ...
   <video width="640" height="360" controls>
      <source src="public/vid/03-1/predicate_conditions.mp4" type="video/mp4">
   </video>
...
- [[all_of]](/Wiqi/doc/1/03/2)
- [[any_of]](/Wiqi/doc/1/03/3)
- [[entity_properties]](/Wiqi/doc/1/03/4)
- [[inverted]](/Wiqi/doc/1/03/5)
- [[location_check]](/Wiqi/doc/1/03/6)
- [[weather_check]](/Wiqi/doc/1/03/7)